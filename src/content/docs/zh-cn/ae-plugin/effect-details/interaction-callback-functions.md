...
尽管在 [PF_InData](../effect-basics/PF_InData.md#pf_indata) 中提供了未宏定义的函数指针，但请使用提供的宏来访问它们。看到我们对弃用宏的使用有多严格了吗？让我们把这个当作我们的小秘密。
...
| 函数                        | 用途                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `PF_ADD_PARAM`            | 在[PF_Cmd_PARAM_SETUP](../effect-basics/command-selectors.md#global-selectors) 期间，使用多次调用此函数将插件的参数枚举给 After Effects。                                                                                                                                                                                                                                                                                                   |
|                             | !!! 注意                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
|                             | 分配一个新的[PF_ParamDef](../effect-basics/PF_ParamDef.md#pf_paramdef) 来保存结果；传递给插件的是只读的。                                                                                                                                                                                                                                                                                                                                   |
...
|                             | 不这样做会导致性能下降和内存泄漏。一旦检入，[PF_ParamDef](../effect-basics/PF_ParamDef.md#pf_paramdef) 中的字段将不再有效。                                                                                                                                                                                                                                                                                                                 |
...
effect[n-1] 的输出是 effect[n] 的输入（[param[0]](../effect-basics/PF_ParamDef.md#param-zero)）。
...
在 30fps 合成中检出的 10fps 图层每三帧才需要刷新一次。如果你的效果希望在静态输入图层的情况下每帧更改输出，则需要设置 [PF_Outflag_NON_PARAM_VARY](../effect-basics/PF_OutData.md#pf_outflags)。
