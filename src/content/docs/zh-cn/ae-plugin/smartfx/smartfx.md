...
|          成员          |                                                                                                                                                   用途                                                                                                                                                   |
|------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `PF_SmartRenderInput`  | 由 [PF_RenderRequest](#pf_prerenderextra)、位深度和指向 `pre_render_data` 的指针（在 [PF_Cmd_SMART_PRE_RENDER](../effect-basics/command-selectors.md#frame-selectors) 期间分配）组成。                                                                                                 |
|                        | 此 `PF_SmartRenderInput` 与相应的 *PF_Cmd_SMART_PRE_RENDER* 中传递的相同。                                                                                                                                                                                                      |
...
|                        | 这用于实际访问在 *PF_Cmd_SMART_PRE_RENDER* 期间签出的图层中的像素。                                                                                                                                                                                                          |
|                        | 返回的 `PF_EffectWorld` 在当前命令期间或直到签入之前有效。                                                                                                                                                                                                                 |
|                        | 你只能使用之前在 *PF_Cmd_SMART_PRERENDER* 中使用的 `checkout_idL` 调用 `checkout_layer_pixels` 一次。                                                                                                                                                                              |
|                        | 在 *PF_Cmd_SMART_PRERENDER* 和 *PF_Cmd_SMART_RENDER* 之间必须有一对一的签出映射。                                                                                                                                                                              |
|                        | 要在图层上多次调用 `checkout_layer_pixels`，你应该在 *PF_Cmd_SMART_PRERENDER* 中再次使用不同的唯一 `checkout_idL` 调用 [checkout_layer](#pf_prerenderextra)，然后在 *PF_Cmd_SMART_RENDER* 中使用该 `checkout_idL` 进行另一次 `checkout_layer_pixels`。 |
